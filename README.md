...
小云雀是字节跳动/剪映旗下的 AI 综合创作平台，同时服务于人类创作者和 AI Agent。本技能让 Openclaw/Claude Code 等 AI Agent 能够作为"传话人"，将用户的创作需求转发给小云雀后端 Agent 处理。
...
```bash
# 交互式选择要安装的技能
npx skills add 待定 -y -g

# 直接安装指定技能
npx skills add 待定 --skill xyq-skill
```
